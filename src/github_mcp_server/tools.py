        ...
        try:
            if name == "github_create_issue":
                ...
                if not repo or issue_number is None:
                    return [types.TextContent(type="text", text="Error: 'repo' and 'issue_number' are required")]
                ...
                issue = github_client.update_issue(
                    ...
                    labels=labels, assignees=assignees, state_reason=state_reason
                )
                ...
                if not repo or pr_number is None:
                    return [types.TextContent(type="text", text="Error: 'repo' and 'pr_number' are required")]
                ...
                if not repo or number is None or not comment:
                    return [types.TextContent(type="text", text="Error: 'repo', 'number', and 'comment' are required")]
                ...
                if not repo or not branch_name:
                    return [types.TextContent(type="text", text="Error: 'repo' and 'branch_name' are required")]
                ...
                result = {
                    "success": success,
                    "message": f"Branch '{branch_name}' deleted successfully" if success else "Failed to delete branch"
                }
                ...
                commits = github_client.get_commits(
                    repo, sha=sha, path=path, author=author,
                ...
                runs = github_client.get_workflow_runs(
                    repo, workflow_id=workflow_id, status=status,
